"""Updated prompts.py to use Bali venue prompts from LangSmith."""
...
USE_LANGSMITH_PROMPTS = os.getenv("USE_LANGSMITH_PROMPTS", "true").lower() == "true"
...
if USE_LANGSMITH_PROMPTS:
    try:
        ...
        # Fetch Bali-specific prompts from LangSmith
        ...
        logger.info("Using Bali venue prompts from LangSmith")
...
if not USE_LANGSMITH_PROMPTS:
    # Use custom prompts as fallback
