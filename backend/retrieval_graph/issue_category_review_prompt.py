...
- **Client Exp** - Client experience and satisfaction (Bubble ID: 1683764027028x314003986352177150)
- **Weddings** - Wedding planning and execution (Bubble ID: 1693533657343x969937389721485300)
- **Guests & Accom** - Guest services and accommodations (Bubble ID: 1741142526992x988389256100053000)
- **Event Requests** - Event planning and special requests (Bubble ID: 1718583276371x601530858772889600)
- **Vendor & Product Requests** - Vendor management and product sourcing (Bubble ID: 1683764063723x899495422051483600)
- **Catalog** - Product and service catalog management (Bubble ID: 1683764033628x667123255737843700)
- **Accounts** - Account management and billing (Bubble ID: 1683764048683x626863668112916500)
- **Metabase** - Data and reporting infrastructure (Bubble ID: 1742966612846x527561452523880450)
- **App Requests** - Mobile and web app feature requests (Bubble ID: 1698451776177x772559502883684400)
- **App Updates** - App maintenance and updates (Bubble ID: 1717457649476x806368590729052200)
- **Digital** - Digital marketing and online presence (Bubble ID: 1738915817674x528837169408639000)
- **Revenue** - Revenue optimization and pricing (Bubble ID: 1683764078523x515115226215481340)
- **People** - HR and team management (Bubble ID: 1740104677509x760140252792750100)
- **Leaders** - Leadership and strategic initiatives (Bubble ID: 1744589859864x437635632404889600)
- **AI Workflows** - AI and automation processes (Bubble ID: 1745224797844x667612769532248000)
- **Venues** - Venue partnerships and management (Bubble ID: 1747016792559x455050911166758900)
- **Content** - Content creation and management (Bubble ID: 1747283209160x324311400399765500)
- **Styling** - Design and styling services (Bubble ID: 1750390525543x913410424778522600)
- **Vehicles** - Transportation and vehicle management (Bubble ID: 1752649475036x855202485836447700)
